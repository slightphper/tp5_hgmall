...
$(function(){
	...
	{   
		Ajax.call(ajax_cart_total, 'goodsIds=' + rec_id, change_cart_goods_response, 'POST','JSON');                
	}
	...
	function replace_cart_goods(rec_id, favourable_id, $this)
	{
		...
		Ajax.call(ajax_cart_total, 'goodsIds=' + rec_id + select_flag + ajax_where, replace_cart_goods_response, 'POST','JSON');                
	}
