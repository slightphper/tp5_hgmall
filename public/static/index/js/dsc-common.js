...
$(function(){
	...
	$("*[ectype='cateItem']").on('mouseenter',function(){
		...
		if(eveval != 1){
			...
			/*加载中by wu*/
			//加载图片路径拼装
			html = '<img src="'+load_img+'" width="200" height="200" class="lazy">'
	...
	$("*[data-dialog='remove_collect_dialog']").click(function(){
		...
		if(user_id > 0){
			...
			var back_url = "flow.php";
			$.notLogin("/index/Flow/loginDialog",back_url);
		}
	});
	...
	$("#go_pay").click(function(){
		var back_act=$(this).data("url");
		$.notLogin("/index/Flow/loginDialog",back_act);
		return false;
	});
